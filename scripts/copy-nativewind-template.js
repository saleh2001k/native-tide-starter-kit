...
const TEMPLATE_DIR = path.join(__dirname, "..", "template-nativewind");
...
// Directories to copy
const DIRS_TO_COPY = ["src", "assets", "scripts"];
...
async function main() {
  console.log("Copying NativeWind template files...");
  ...
  console.log("NativeWind template files copied successfully!");
}
